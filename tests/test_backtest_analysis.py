...
def _trade(**overrides) -> Trade:
    defaults = dict(
        ...
        stop_price=95.0, target_price=110.0, atr=1.0, risk_reward_ratio=2.2, screening_rr=2.2, execution_rr=2.2,
        confluence_score=2, opportunity_score=0.5, volume_surge_ratio=2.5, trend_alignment=True,
