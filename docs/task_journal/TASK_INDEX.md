...
| **120A–C (corrected baseline + Original/Experimental decision)** | 2026-09-12 | research | `TASK120_CORRECTIONS_COMPLETE` / `CHRONOLOGICAL_BASELINE_COMPLETE_INCONCLUSIVE` (N=57, CI includes zero) / `INSUFFICIENT_EVIDENCE_WITH_ONE_SPECIFIC_NEXT_ACTION`; corrected N=27→N=57 chronological replay, 6-name coverage bug fixed (only SHOP genuinely missing), Original's exact-contract evidence cited (Task 93) | `docs/research/{TASK120ABC_CORRECTED_BASELINE_AND_DECISION,TASK120A_COVERAGE_RECONCILIATION,PRODUCT_STATUS}.md` | **AVAILABLE** — `entries/2026-09-12_task120abc_baseline_correction_decision/request.md` |
