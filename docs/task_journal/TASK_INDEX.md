...
| **120 (39-name scope economic decision)** | 2026-09-12 | research | `NO_SUPPORTED_STRATEGY_CHANGE`; N=27 full-history 39-name-scope replay, CI includes zero; 6-name price-coverage gap identified (incl. MSTR) | `docs/research/{TASK120_PROTOCOL_39NAME_SCOPE_REPLAY,TASK120_ECONOMIC_DECISION}.md` | **AVAILABLE** — `entries/2026-09-12_task120_economic_decision/request.md` |
