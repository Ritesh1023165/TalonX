...
.venv\Scripts\python.exe -m talonx_v2.release_gate                     # status READY; strategy e2acf6454789217e, provider ac5e51aa3599d6c9
```
...
- the activating filing's `insider_transactions.accepted_at_utc` and `insider_filings.ingested_at_utc`
