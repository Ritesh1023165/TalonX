...
| Cluster | Symbol | Activation (SEC-accepted) | Durable receipt | Entry session | Category | Admission result | Fill price | Shares | Capital used | Exit target session | Actual exit (session / price) | Realized price P&L | Dividends | Total return | R | Reason if not traded |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `07242bc857569f60` | ABCL | 2026-08-14 16:04:25Z | 2026-09-04 10:18:49Z | 2026-08-17 | pre-campaign | `SKIPPED_ENTRY_STALE` | — | — | — | — | — | — | — | — | n/a | entry session predated the campaign; stale |
| `19f814d1f3ec3250` | ADC | 2026-09-17 11:00:24Z | 2026-09-21 18:42:40Z | 2026-09-18 | `MISSED_DUE_TO_INGESTION_DOWNTIME` (pre-campaign) | `SKIPPED_NO_PRIOR_INTENT` (intent path NOT_REACHED) | — | — | — | — | — | — | — | — | n/a | filing received after the entry session; ingester offline 09-16 to 09-20; campaign created 09-21 |
...
| Opportunities missed due to ingestion downtime (in-campaign) | 0 (1 pre-campaign: ADC) |
