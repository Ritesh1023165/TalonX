...
- Module 2's indicator periods/thresholds plus its noise and
  ...
  `TALONX_QUANT_HTF_SMA_PERIOD`, `TALONX_QUANT_TREND_GATE_ENABLED`) and
  buffer persistence (`TALONX_QUANT_BUFFER_CHECKPOINT_SECONDS`,
  `TALONX_QUANT_BUFFER_RELOAD_MAX_GAP_SECONDS` — see
